import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o,c as p,a as n,b as s,d as e,e as l}from"./app-2750ec31.js";const c={},d=l('<h1 id="mysql-运维" tabindex="-1"><a class="header-anchor" href="#mysql-运维" aria-hidden="true">#</a> MySQL 运维</h1><div class="hint-container info"><p class="hint-container-title">概述</p><p>如果你的公司有 DBA，那么我恭喜你，你可以无视 MySQL 运维。如果你的公司没有 DBA，那你就好好学两手 MySQL 基本运维操作，行走江湖，防身必备。</p></div><h2 id="mysql-安装" tabindex="-1"><a class="header-anchor" href="#mysql-安装" aria-hidden="true">#</a> MySQL 安装</h2><h3 id="windows-安装" tabindex="-1"><a class="header-anchor" href="#windows-安装" aria-hidden="true">#</a> Windows 安装</h3><p>（1）下载 MySQL 5.7 免安装版</p>',5),r={href:"https://dev.mysql.com/downloads/mysql/5.7.html#downloads",target:"_blank",rel:"noopener noreferrer"},u=l(`<p>（2）解压并创建 my.ini 在根目录</p><p>my.ini 文件示例：</p><div class="language-ini line-numbers-mode" data-ext="ini"><pre class="language-ini"><code><span class="token section"><span class="token punctuation">[</span><span class="token section-name selector">mysqld</span><span class="token punctuation">]</span></span>
<span class="token comment">#设置 3306 端口</span>
<span class="token key attr-name">port</span> <span class="token punctuation">=</span> <span class="token value attr-value">3306</span>
<span class="token comment"># 设置 mysql 的安装目录 这块换成自己解压的路径</span>
...
<span class="token comment"># 服务端使用的字符集默认为 8 比特编码的 latin1 字符集</span>
...
<span class="token comment"># 设置 mysql 客户端默认字符集</span>
...
Query OK<span class="token punctuation">,</span> <span class="token number">0</span> <span class="token keyword">rows</span> affected <span class="token punctuation">(</span><span class="token number">0.00</span> sec<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>方案二</p><p>修改 <code>my.cnf</code> 文件，在 <code>[mysqld]</code> 节下增加 <code>default-time-zone=&#39;+08:00&#39;</code> ，然后重启。</p><h3 id="数据表损坏如何修复" tabindex="-1"><a class="header-anchor" href="#数据表损坏如何修复" aria-hidden="true">#</a> 数据表损坏如何修复</h3><p>使用 myisamchk 来修复，具体步骤：</p><ol><li>修复前将 mysql 服务停止。</li><li>打开命令行方式，然后进入到 mysql 的 <code>bin</code> 目录。</li><li>执行 myisamchk –recover 数据库所在路 /*.MYI</li></ol><p>使用 repair table 或者 OPTIMIZE table 命令来修复，REPAIR TABLE table_name 修复表 OPTIMIZE TABLE table_name 优化表 REPAIR TABLE 用于修复被破坏的表。 OPTIMIZE TABLE 用于回收闲置的数据库空间，当表上的数据行被删除时，所占据的磁盘空间并没有立即被回收，使用了 OPTIMIZE TABLE 命令后这些空间将被回收，并且对磁盘上的数据行进行重排（注意：是磁盘上，而非数据库）</p><h3 id="数据结构" tabindex="-1"><a class="header-anchor" href="#数据结构" aria-hidden="true">#</a> 数据结构</h3><blockquote><p>问题现象：ERROR 1071: Specified key was too long; max key length is 767 bytes</p></blockquote><p>问题原因：MySQL 默认情况下单个列的索引不能超过 767 位（不同版本可能存在差异） 。</p><p>解决方法：优化索引结构，索引字段不宜过长。</p><h2 id="mysql-运维脚本" tabindex="-1"><a class="header-anchor" href="#mysql-运维脚本" aria-hidden="true">#</a> MySQL 运维脚本</h2><p>这里推荐我写的几个一键运维脚本，非常方便，欢迎使用：</p>`,235),k={href:"https://github.com/dunwu/linux-tutorial/tree/master/codes/linux/soft/mysql-install.sh",target:"_blank",rel:"noopener noreferrer"},b={href:"https://github.com/dunwu/linux-tutorial/tree/master/codes/linux/soft/mysql-backup.sh",target:"_blank",rel:"noopener noreferrer"},y=n("h2",{id:"参考资料",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#参考资料","aria-hidden":"true"},"#"),s(" 参考资料")],-1),g={href:"https://book.douban.com/subject/23008813/",target:"_blank",rel:"noopener noreferrer"},h={href:"https://www.cnblogs.com/xiaopotian/p/8196464.html",target:"_blank",rel:"noopener noreferrer"},_={href:"https://www.cnblogs.com/bigbrotherer/p/7241845.html",target:"_blank",rel:"noopener noreferrer"},q={href:"https://blog.csdn.net/managementandjava/article/details/80039650",target:"_blank",rel:"noopener noreferrer"},f={href:"http://www.manongjc.com/article/6996.html",target:"_blank",rel:"noopener noreferrer"},w={href:"https://www.cnblogs.com/xyabk/p/8967990.html",target:"_blank",rel:"noopener noreferrer"},S={href:"https://blog.csdn.net/zyhlwzy/article/details/80569422",target:"_blank",rel:"noopener noreferrer"},E={href:"https://juejin.im/post/58eb5d162f301e00624f014a",target:"_blank",rel:"noopener noreferrer"},x={href:"https://juejin.im/entry/5a0aa2026fb9a045132a369f",target:"_blank",rel:"noopener noreferrer"},M={href:"https://www.jianshu.com/p/5f39c486561b",target:"_blank",rel:"noopener noreferrer"};function T(I,L){const a=i("ExternalLinkIcon");return o(),p("div",null,[d,n("p",null,[s("下载地址："),n("a",r,[s("https://dev.mysql.com/downloads/mysql/5.7.html#downloads"),e(a)])]),u,n("p",null,[s("官方下载地址："),n("a",m,[s("https://dev.mysql.com/downloads/repo/yum/"),e(a)])]),v,n("ul",null,[n("li",null,[n("a",k,[s("MySQL 安装脚本"),e(a)])]),n("li",null,[n("a",b,[s("MySQL 备份脚本"),e(a)])])]),y,n("ul",null,[n("li",null,[n("a",g,[s("《高性能 MySQL》"),e(a)])]),n("li",null,[n("a",h,[s("https://www.cnblogs.com/xiaopotian/p/8196464.html"),e(a)])]),n("li",null,[n("a",_,[s("https://www.cnblogs.com/bigbrotherer/p/7241845.html"),e(a)])]),n("li",null,[n("a",q,[s("https://blog.csdn.net/managementandjava/article/details/80039650"),e(a)])]),n("li",null,[n("a",f,[s("http://www.manongjc.com/article/6996.html"),e(a)])]),n("li",null,[n("a",w,[s("https://www.cnblogs.com/xyabk/p/8967990.html"),e(a)])]),n("li",null,[n("a",S,[s("MySQL 8.0 主从（Master-Slave）配置"),e(a)])]),n("li",null,[n("a",E,[s("MySQL 主从同步实战"),e(a)])]),n("li",null,[n("a",x,[s("MySQL 备份和恢复机制"),e(a)])]),n("li",null,[n("a",M,[s("MySQL 配置文件/etc/my.cnf 解析"),e(a)])])])])}const A=t(c,[["render",T],["__file","index.html.vue"]]);export{A as default};
